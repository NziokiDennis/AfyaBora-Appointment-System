<nav class="navbar navbar-expand-lg navbar-dark" style="background:linear-gradient(135deg,#1a6fe8 0%, #1259c4 100%); box-shadow:0 8px 20px rgba(26,111,232,.18);">
    <div class="container">
        <a class="navbar-brand fw-semibold" href="dashboard.php">Reception Desk</a>
